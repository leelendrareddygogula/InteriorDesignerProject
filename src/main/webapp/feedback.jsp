...
<body>
	...
	<center>
		...
		<h2 align="center">Your Feedback Helps Us  </h2>
		<form action="/customer/submitfeedback" method="post">
			<table>
				<tr>
					<td><label style="margin-top: 1.5%;"><b>You are?</b></label></td></td>
					<td>
						  <select name="customerdetails" required="required">
						    <option value="">---select---</option>
						    <c:forEach items="${customerList}" var="customer">
								<option value="${customer.id}™${customer.name} - ${customer.address}">${customer.name} - ${customer.address}</option>
							</c:forEach>
						  </select>
					</td>
				</tr>
				<tr>
					<td><b>Rate quality of our work? </b></td>
					<td>
						<div class="labelrating">
						<label>Lowest</label>
							&nbsp;
							  	<div class="rating">
									  <input id="rating1" type="radio" required name="workquality" value="1">
									  <label for="rating1"></label>
									  <input id="rating2" type="radio" required name="workquality" value="2">
									  <label for="rating2"></label>
									  <input id="rating3" type="radio" required name="workquality" value="3">
									  <label for="rating3"></label>
									  <input id="rating4" type="radio" required name="workquality" value="4">
									  <label for="rating4"></label>
									  <input id="rating5" type="radio" required name="workquality" value="5">
				...
				<tr>
					<td><b>Rate designs and models available with us? </b></td>
					<td><div class="labelrating">
						<label>Lowest</label>
							&nbsp;
							<div class="rating">
								  <input id="rating11" type="radio" required name="designsavail" value="1">
								  <label for="rating11"></label>
								  <input id="rating22" type="radio" required name="designsavail" value="2">
								  <label for="rating22"></label>
								  <input id="rating33" type="radio" required name="designsavail" value="3">
								  <label for="rating33"></label>
								  <input id="rating44" type="radio" required name="designsavail" value="4">
								  <label for="rating44"></label>
								  <input id="rating55" type="radio" required name="designsavail" value="5">
				...
				<tr>
					<td><b>How satisfied are you with the colour precision from books to live colours?</b></td>
					<td>
							<div class="labelrating">
						<label>Less satisfied</label>
							&nbsp;
								<div class="rating">
									  <input id="rating111" type="radio" required name="colourprecesion" value="1">
									  <label for="rating111"></label>
									  <input id="rating222" type="radio" required name="colourprecesion" value="2">
									  <label for="rating222"></label>
									  <input id="rating333" type="radio" required name="colourprecesion" value="3">
									  <label for="rating333"></label>
									  <input id="rating444" type="radio" required name="colourprecesion" value="4">
									  <label for="rating444"></label>
									  <input id="rating555" type="radio" required name="colourprecesion" value="5">
									  <label for="rating555"></label>
								</div>
							&nbsp;
							<label>More satisfied</label>
						</div>
					</td>
				</tr>
				<tr>
					<td><b>How satisfied are you with the changes that you told were implemented by us?</b></td>
					<td>
						<div class="labelrating">
						<label>Less satisfied</label>
							&nbsp;
							<div class="rating">
									  <input id="rating1111" type="radio" required name="changesimpl" value="1">
									  <label for="rating1111"></label>
									  <input id="rating2222" type="radio" required name="changesimpl" value="2">
									  <label for="rating2222"></label>
									  <input id="rating3333" type="radio" required name="changesimpl" value="3">
									  <label for="rating3333"></label>
									  <input id="rating4444" type="radio" required name="changesimpl" value="4">
									  <label for="rating4444"></label>
									  <input id="rating5555" type="radio" required name="changesimpl" value="5">
									  <label for="rating5555"></label>
							</div>
						&nbsp;
							<label>Highest</label>
						</div>
				...
				<tr>
					<td><b>How much do you rate the communication between you and us?</b></td>
					<td>
						<div class="labelrating">
						<label>Have to improve</label>
							&nbsp;
							<div class="rating">
								  <input id="rating111111" type="radio" required name="communication" value="1">
								  <label for="rating111111"></label>
								  <input id="rating222222" type="radio" required name="communication" value="2">
								  <label for="rating222222"></label>
								  <input id="rating333333" type="radio" required name="communication" value="3">
								  <label for="rating333333"></label>
								  <input id="rating444444" type="radio" required name="communication" value="4">
								  <label for="rating444444"></label>
								  <input id="rating555555" type="radio" required name="communication" value="5">
								  <label for="rating555555"></label>
							</div>
						&nbsp;
							<label>Happy enough</label>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td><label style="margin-top: 1.5%;"><b>Please select one of the options regarding the timeline of the project, </b></label></td></td>
					<td>
					<div class="selectinput1">
						<select name="projecttimeline" required="required" style="width: 65%;">
							<option value="">---select---</option>
							<option value="Fully Completed">Everything was completed with in the promised date</option>
							<option value="Almost completed">Almost work is completed within the promised date with minor works to be done</option>
							<option value="Only some part completed">Only some part of the work was completed and remaining need to be completed even after promised date</option>
							<option value="Work stopped">Work was stopped in between because of issues from designer</option>
						</select>
						</div>
					</td>
					</div>
				...
				<tr>
					<td><b>Please leave a comment :-), </b></td>
					<td><textarea rows="10" name="customerinput" id="customerinput"></textarea></td>
				</tr>
				<tr>
